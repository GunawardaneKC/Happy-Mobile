...
const Home = () => {
  ...
  return (
    <div className='container'>
      ...
      <div>
        <button className="btn btn-success"><Link to='/add' style={{textDecoration: 'none', color:'white'}}>Add New Repair</Link></button>&nbsp;
        <button className="btn btn-primary">
          <Link to='/completed' style={{textDecoration: 'none', color:'white'}}>View Completed Repairs</Link>
        </button>
      </div>

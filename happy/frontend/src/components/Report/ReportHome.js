    ...
    <div className='card-container1x mb-5'>
       ...
       <div className="image-container row">
        ...
        <div className="text-center"> 
                    ...
                    <a className="btn btn-dark" href={`/repair/reports`}><BsCaretRightSquare/></a>
          </div>          
       </div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
       ...
       <div className="image-container row">
        ...
        <div className="text-center"> 
                    ...
                    <a className="btn btn-dark" href={`/RentRep`}><BsCaretRightSquare/></a>
       ...
       <div className="image-container row">
        ...
        <div className="text-center"> 
                    ...
                    <a className="btn btn-dark" href={`/stockR`}><BsCaretRightSquare/></a>
          </div>          
       </div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;

  ...
  return (
    <div className="admin"> 
      <div className='Slidebar'><br/>
        <h4 className='text-center mb-5' style={{color:'white'}}>Admin</h4>
        ...
        <div className='item'><a className='btn btn-primary col-12'style={{background:"rgb(23, 102, 221)"}} href={'/Home'}><AiOutlineHome/>&nbsp;Home</a></div><br/>
        <div className='item'><a className='btn btn-primary col-12'style={{background:"rgb(23, 102, 221)"}} href={'/admin'}><FiSettings/>&nbsp;Web Setting</a></div><br/>
        ...
        <div className='item' ><a className='btn btn-primary col-12' style={{background:"rgb(23, 102, 221)"}}href={'/admin'}><MdAttachMoney/>&nbsp;Financial</a></div><br/>
        ...
        <div className='item' style={{background:"red"}}><a className='btn btn-danger col-12' style={{background:"red"}} href={'/login'}><SlLogout/>&nbsp;LogOut</a></div><br/>
         ...
         <div className='copyright'></div><br/>
        </div>
       <br/><br/>
    ...
    <div className='card-container1 mb-5'>
       ...
       <div className="image-container row">
        ...
        <div className="text-center"> 
                    ...
                    <a className="btn btn-warning" href={`/repair`}><BsCaretRightSquare/></a>
          </div>          
       </div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
       ...
       <div className="image-container row">
        ...
        <div className="text-center"> 
                    <div className='card-title'>Supplier Management</div>
                    <a className="btn btn-primary" href={`/Supplier`}><BsCaretRightSquare/></a>
          </div>          
       </div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
       ...
       <div className="image-container row">
        ...
        <div className="text-center"> 
                    ...
                    <a className="btn btn-dark" href={`/AdminReturn`}><BsCaretRightSquare/></a>
          </div>          
       </div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
